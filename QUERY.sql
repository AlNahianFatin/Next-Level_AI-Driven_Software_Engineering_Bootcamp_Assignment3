...
select booking_id, full_name, fixture, round(total_cost) 
  from bookings as b
  join users as u on b.user_id=u.user_id
  join matches as m on b.match_id=m.match_id;

-- Query 5: Display a comprehensive list of all users and their 
-- booking IDs, ensuring that fans who have never bought a ticket 
-- are still listed.
